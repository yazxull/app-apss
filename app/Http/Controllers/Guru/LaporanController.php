...
class LaporanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('guru.laporan.index', compact('laporan', 'stats', 'kategori'));
    }
    ...
    public function feedback(Request $request, Aspirasi $aspirasi)
    {
        ...
        return redirect()->route('guru.laporan.index')->with('success', 'Terima kasih atas feedback Anda.');
    }
