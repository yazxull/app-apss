...
@section('title', 'Akun Saya - Pegawai')
...
<div class="row g-4">
            ...
            <div class="card-body">
                <div class="profile-banner">
                    ...
                    <div>
                        ...
                        <div class="profile-role">Pegawai · {{ $pegawai->jabatan ?? 'Staff' }}</div>
                    </div>
                </div>

                <form action="{{ route('pegawai.akun.update') }}" method="POST">
                    @csrf @method('PUT')
                    ...
                    <div class="info-note mb-4">
                        ...
                        Username tidak dapat diubah. Hubungi admin jika perlu perubahan.
                    </div>
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('pegawai.akun.password') }}" method="POST">
                    @csrf @method('PUT')
